...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Advice.image'
        db.alter_column(u'toolbox_advice', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['filer.Image']))

        # Changing field 'Tool.image'
        db.alter_column(u'toolbox_tool', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['filer.Image']))

    def backwards(self, orm):

        # Changing field 'Advice.image'
        db.alter_column(u'toolbox_advice', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Image']))

        # Changing field 'Tool.image'
        db.alter_column(u'toolbox_tool', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Image']))
