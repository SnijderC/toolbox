...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advice.creationdate'
        db.add_column(u'toolbox_advice', 'creationdate',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 4, 20, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Tool.creationdate'
        db.add_column(u'toolbox_tool', 'creationdate',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 4, 20, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Manual.creationdate'
        db.add_column(u'toolbox_manual', 'creationdate',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 4, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advice.creationdate'
        db.delete_column(u'toolbox_advice', 'creationdate')

        # Deleting field 'Tool.creationdate'
        db.delete_column(u'toolbox_tool', 'creationdate')

        # Deleting field 'Manual.creationdate'
        db.delete_column(u'toolbox_manual', 'creationdate')
