    ...
    <div role="tabpanel">
        <ul class="nav nav-tabs" role="tablist">
            <li class="active" role="presentation">
                <a aria-controls="tab1" data-toggle="tab" href="#tab1" role="tab"> Tab 1</a>
            </li>
            <li role="presentation">
                <a aria-controls="tab2" data-toggle="tab" href="#tab2" role="tab">Tab 2</a>
            </li>
            <li role="presentation">
                <a aria-controls="tab2-1" data-toggle="tab" href="#tab2-1" role="tab">Tab 2</a>
            </li>
        </ul>
...
class BootstrapTabBlockProcessor(BlockProcessor):
    ...
    def run(self, parent, blocks):
        ...
        if sibling != None and sibling.tag == "div" and sibling.get("role") == "tabpanel":
            # The last child was a tabblock, append this block to the tab block.
            
            # loop through the parent's children to locate the tablist (ul) and the tab-content (div)
            ...
            tablist    = etree.SubElement(tabblock, 'ul', **{'role':"tablist", 'class':"nav nav-tabs"})
            tabcontent = etree.SubElement(tabblock, 'div', **{'class':"tab-content"})
        ...
        block = blocks.pop(0)
        for m in re.finditer(self.MATCH_RE, block): #blocks may be attached (no newline)
            ...
            a_kw = {'href':"#%s"%uq_id,'aria-controls':uq_id, 'role':"tab", 'data-toggle':"tab"}
...
class BootstrapTabExtension(Extension):
    ...
    def extendMarkdown(self, md, md_globals):
        ...
        md.parser.blockprocessors.add('bootstrap_tab', BootstrapTabBlockProcessor(md.parser),"<hr")
