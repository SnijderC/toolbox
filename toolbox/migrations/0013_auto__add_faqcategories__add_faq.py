...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FAQCategories'
        db.create_table(u'toolbox_faqcategories', (
        ...
        db.send_create_signal('toolbox', ['FAQCategories'])

        # Adding model 'FAQ'
        db.create_table(u'toolbox_faq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('answer_md', self.gf('django.db.models.fields.TextField')()),
            ('answer_html', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('toolbox', ['FAQ'])

        # Adding M2M table for field categories on 'FAQ'
        m2m_table_name = db.shorten_name(u'toolbox_faq_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('faq', models.ForeignKey(orm['toolbox.faq'], null=False)),
            ('faqcategories', models.ForeignKey(orm['toolbox.faqcategories'], null=False))
        ))
        db.create_unique(m2m_table_name, ['faq_id', 'faqcategories_id'])


    def backwards(self, orm):
        # Deleting model 'FAQCategories'
        db.delete_table(u'toolbox_faqcategories')

        # Deleting model 'FAQ'
        db.delete_table(u'toolbox_faq')

        # Removing M2M table for field categories on 'FAQ'
        db.delete_table(db.shorten_name(u'toolbox_faq_categories'))
    ...
    models = {
        ...
        'toolbox.faq': {
            ...
            'answer_html': ('django.db.models.fields.TextField', [], {}),
