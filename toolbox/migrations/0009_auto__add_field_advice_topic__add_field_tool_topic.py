...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advice.topic'
        db.add_column(u'toolbox_advice', 'topic',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'Tool.topic'
        db.add_column(u'toolbox_tool', 'topic',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advice.topic'
        db.delete_column(u'toolbox_advice', 'topic')

        # Deleting field 'Tool.topic'
        db.delete_column(u'toolbox_tool', 'topic')
