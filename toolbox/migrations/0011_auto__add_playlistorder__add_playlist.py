...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlaylistOrder'
        db.create_table(u'toolbox_playlistorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('playlist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['toolbox.Playlist'])),
            ('advice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['toolbox.Advice'])),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('toolbox', ['PlaylistOrder'])

        # Adding model 'Playlist'
        db.create_table(u'toolbox_playlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('i_want_to', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ...
        db.send_create_signal('toolbox', ['Playlist'])


    def backwards(self, orm):
        # Deleting model 'PlaylistOrder'
        db.delete_table(u'toolbox_playlistorder')

        # Deleting model 'Playlist'
        db.delete_table(u'toolbox_playlist')
    ...
    models = {
        ...
        'toolbox.playlist': {
            ...
            'intro_html': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'intro_md': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'playlist': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'playlist_items'", 'blank': 'True', 'through': "orm['toolbox.PlaylistOrder']", 'to': "orm['toolbox.Advice']"}),
            'published': ('django.db.models.fields.BooleanField', [], {}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '60'})
        },
