...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:        
            print 'Removing FULLTEXT INDEX on field "title" of tables "toolbox_playlist"..'
            db.execute("ALTER TABLE toolbox_playlist DROP INDEX tb_search;")
        except Exception, e:
            if '__cause__' in e.__dict__:
                if e.__cause__[0] == 1091:
                    ...
                    raise e
        try:
            print 'Generating FULLTEXT INDEX on field(s) "title, intro_md" of tables "toolbox_playlist"..'
            db.execute("ALTER TABLE toolbox_playlist ADD FULLTEXT tb_search (title,intro_md);")
            print "Indexes updated succesfully!"
        except:
            raise RuntimeError("Some index update failed!")
        
        

    def backwards(self, orm):
        try:        
            print 'Removing FULLTEXT INDEX on field "title, intro_md" of tables "toolbox_playlist"..'
            db.execute("ALTER TABLE toolbox_playlist DROP INDEX tb_search;")
        except Exception, e:
            if '__cause__' in e.__dict__:
                if e.__cause__[0] == 1091:
                    ...
                    raise e
        try:
            print 'Generating FULLTEXT INDEX on field(s) "title" of tables "toolbox_playlist"..'
            db.execute("ALTER TABLE toolbox_playlist ADD FULLTEXT tb_search (title);")
            print "Indexes reverted succesfully!"
        except:
            raise RuntimeError("Some index reversal failed!")
