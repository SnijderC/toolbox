...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Formfactor.show_in_nav'
        db.delete_column(u'toolbox_formfactor', 'show_in_nav')

        # Deleting field 'Category.show_in_nav'
        db.delete_column(u'toolbox_category', 'show_in_nav')

        # Deleting field 'ParentCategories.show_in_nav'
        db.delete_column(u'toolbox_parentcategories', 'show_in_nav')


    def backwards(self, orm):
        # Adding field 'Formfactor.show_in_nav'
        db.add_column(u'toolbox_formfactor', 'show_in_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Category.show_in_nav'
        db.add_column(u'toolbox_category', 'show_in_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ParentCategories.show_in_nav'
        db.add_column(u'toolbox_parentcategories', 'show_in_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
