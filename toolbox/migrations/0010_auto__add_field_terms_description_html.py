...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Terms.description_html'
        db.add_column(u'toolbox_terms', 'description_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Terms.description_html'
        db.delete_column(u'toolbox_terms', 'description_html')
