...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tool.license'
        db.alter_column(u'toolbox_tool', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['toolbox.License'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Tool.license'
        db.alter_column(u'toolbox_tool', 'license_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['toolbox.License']))
